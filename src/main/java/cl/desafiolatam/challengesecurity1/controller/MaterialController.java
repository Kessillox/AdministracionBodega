...
public class MaterialController {
    ...
    public RedirectView home(HttpSession , @ModelAttribute Material material) {//Los valores recibidos desde el formulario son almacenados directamente en la sesión. Se agrega a una lista de valores en la que se ingresa desde las vistas con el nombre valores.

        List<Material> materials =  ArrayList<>();									//Se crea una lista de "Material"es
